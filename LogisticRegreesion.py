...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_data_path', type=str,
                        default='/Users/ryan/Downloads/X_train', dest='train_data_path',
                        help='Path to training data')
    parser.add_argument('--train_label_path', type=str,
                        default='/Users/ryan/Downloads/Y_train', dest='train_label_path',
                        help='Path to training data\'s label')
    parser.add_argument('--test_data_path', type=str,
                        default='/Users/ryan/Downloads/X_test', dest='test_data_path',
                        help='Path to testing data')
    parser.add_argument('--save_dir', type=str,
                        default='/Users/ryan/Downloads/logistic_model/', dest='save_dir',
                        help='Path to save the model parameters')
    parser.add_argument('--output_dir', type=str,
                        default='/Users/ryan/Downloads/logistic_output/', dest='output_dir',
                        help='Path to save the model parameters')
